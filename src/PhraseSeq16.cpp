...
struct PhraseSeq16Widget : ModuleWidget {
	...
	PhraseSeq16Widget(PhraseSeq16 *module) : ModuleWidget(module) {
		...
		addParam(ParamWidget::create<IMSmallKnob>(Vec(columnRulerB1 + offsetRoundSmallBlackKnob, rowRulerB1 + offsetRoundSmallBlackKnob), module, PhraseSeq16::GATE1_KNOB_PARAM, 0.0f, 1.0f, 1.0f));
		...
		// Slide knob
		addParam(ParamWidget::create<IMSmallKnob>(Vec(columnRulerB3 + offsetRoundSmallBlackKnob, rowRulerB1 + offsetRoundSmallBlackKnob), module, PhraseSeq16::SLIDE_KNOB_PARAM, 0.0f, 2.0f, 0.2f));
		// Autostep
