...
* Thanks also to **Pyer (Pierre Collard)**, **Alfredo Santamaria**, **Nay Seven**, **Alberto Zamora**, **Clément Foulc**, **Espen Storo**, **Wouter Spekkink**, **Jakub Mudrak**, **John Melcher** for suggesting improvements to the modules, bug reports and testing.
