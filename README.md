...
Here are some specific details on each element on the faceplate of the module. For a brief tutorial on seting up the controller, please see [this segment](https://www.youtube.com/watch?v=KOpo2oUPTjg&t=874s) or [this segment](https://www.youtube.com/watch?v=hbxlK07PQAI&t=4614s) of Nigel Sixsmith's Talking Rackheads series.
...
A 32 phrase sequencer module, where each phrase is an index into a set of 32 sequences of 32 steps (maximum). CVs can be entered via a CV input when using an external keyboard controller or via the built-in keyboard on the module itself.

Ideas: If you need a 1024-step sequence in a single module, this is the sequencer for you!
